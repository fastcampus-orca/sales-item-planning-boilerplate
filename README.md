...
모든 경로는 프로젝트 루트 기준입니다. 요청받은 작업에 해당하는 파일만 생성하거나 갱신하고, 작업 후 실제 저장한 파일을 알려 줍니다.
...
품질 검토를 맡은 코디네이터만 실제 문서를 품질 기준과 대조하고 `quality-review.md`에 아래 내용을 기록합니다. 시장조사·후보 비교·기획서 작성 담당은 이 파일을 생성하거나 수정하지 않습니다.
...
웹페이지 작성 담당은 점검 결과와 공유 URL을 대화로 보고하고, 코디네이터가 품질 검사 기록에 반영합니다. 기획서가 수정되면 재검사 후 페이지에도 반영합니다.
